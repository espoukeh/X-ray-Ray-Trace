...
printf(
"Creates a parallelogram and propagates all rays to it.\n"
"Sets all rays outside parallelogram to 0 intensity. Parallelogram defined by\n"
...
//	}
	//unsigned char object[65536];
	//FILE *image1 = fopen("image","rb");
	//fread(object,sizeof(object),1,image1);
        ...
        while (!feof(in)) {
                ...
                //parallelogram plane along propagation direction
                ...
                point_B1 = dot(point,B1);
                point_B2 = dot(point,B2);
